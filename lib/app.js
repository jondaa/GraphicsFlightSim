...
function drawScene() {
		...
		wvpMats = worldViewProjection(carX, carY, carZ, carAngle, cx, cy, cz, aspectRatio);
...
function displayAlt(alt,vel){
	...
	ctx.font = "30px Arial";
	ctx.color='grey';
	ctx.fillText("Altitude: "+Math.round(alt)+"\n"+"Velocity: "+Math.round(vel), 10, 50);
}